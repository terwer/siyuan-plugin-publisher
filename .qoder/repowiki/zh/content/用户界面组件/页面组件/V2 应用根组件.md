...
- [Setting.vue](file://src/pages/Setting.vue)
...
## 更新摘要
**变更内容**
- 更新了标题显示逻辑，从'Publisher'改为'发布工具'
- 更新了设置视图标题，从'Settings Workspace'改为'设置'
- 改进了当前文档上下文的展示机制
- 更新了国际化支持和路由配置
...
**更新** 标题系统已从英文国际化更新为中文本地化，提供更好的用户体验。
...
5. **标题本地化**：采用中文标题'发布工具'替代英文'Publisher'
...
**更新** 标题系统已从国际化键值更新为直接的中文显示，提供更直观的用户体验。
...
**更新** 当前文档上下文展示已从简单的"请先打开一个文档"改进为显示实际的文档标题，提供更丰富的用户体验。
...
**更新** 设置视图标题已从'Settings Workspace'更新为'设置'，提供更简洁直观的界面。
...
**更新** 当前文档上下文展示已从简单的占位符更新为显示实际的文档标题，提供更丰富的用户体验。
