...
- [smoke-m0.md](file://openspec/changes/refactor-ui-v2-foundation/smoke-m0.md)
...
+hasPlatforms : ComputedRef
+init() Promise
+platformItems : V2QuickPublishPlatformItem[]
}
V2App --> UnifiedWorkspaceShell : "包含"
V2App --> UseV2QuickPublish : "使用"
V2App --> V2PlatformCard : "渲染"
...
PrefStore[usePreferenceSettingStore.ts]
PublishStore[发布设置存储]
end
subgraph "样式层"
...
- [smoke-m0.md:1-26](file://openspec/changes/refactor-ui-v2-foundation/smoke-m0.md#L1-L26)
...
- [V2App.vue:129-143](file://src/components/v2/V2App.vue#L129-L143)
...
**章节来源**
- [smoke-m0.md:15-26](file://openspec/changes/refactor-ui-v2-foundation/smoke-m0.md#L15-L26)
