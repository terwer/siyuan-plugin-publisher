...
- [TODO/v2-commit-guide.md](file://TODO/v2-commit-guide.md)
...
### V2 快速发布与设置状态管理
- **快速发布状态**：useV2QuickPublish 管理当前文档上下文、平台列表、发布状态与预览链接。
- **设置状态**：useV2Settings 管理账户列表、平台选择、配置表单与环境适配。
- **国际化支持**：useV2I18n 提供宿主 i18n 优先的文本解析与回退机制。

**章节来源**
- [src/composables/v2/useV2QuickPublish.ts:1-321](file://src/composables/v2/useV2QuickPublish.ts#L1-L321)
- [src/composables/v2/useV2Settings.ts:1-250](file://src/composables/v2/useV2Settings.ts#L1-L250)
- [src/composables/v2/useV2I18n.ts:1-90](file://src/composables/v2/useV2I18n.ts#L1-L90)
...
### V2 架构审计指南
- **承载方式迁移**：从 iframe SPA 到原生 DOM 挂载的完整链路
- **业务层复用**：核心发布逻辑继续复用共享 composable
- **入口分流策略**：顶栏主入口与文档菜单的差异化处理
- **平台配置桥接**：26 个直接映射 + 1 个 Electron-only 特例

**章节来源**
- [docs/UI2.0-从SPA到原生DOM挂载-架构接线与代码审计指南.md:1-800](file://docs/UI2.0-从SPA到原生DOM挂载-架构接线与代码审计指南.md#L1-L800)
- [TODO/v2-commit-guide.md:1-68](file://TODO/v2-commit-guide.md#L1-L68)
...
- [README.md:1-102](file://README.md#L1-L102)
- [openspec/changes/refactor-ui-v2-foundation/tasks.md:1-85](file://openspec/changes/refactor-ui-v2-foundation/tasks.md#L1-L85)