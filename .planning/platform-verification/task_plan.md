...
- 宿主启动：`/Applications/SiYuan.app/Contents/MacOS/SiYuan --remote-debugging-port=9222 --workspace=/Volumes/workspace/mydocs/SiYuanWorkspace/test`；软链 `test/data/plugins/siyuan-plugin-publisher -> dist`。
