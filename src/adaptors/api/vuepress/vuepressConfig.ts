 ...
 * @since 1.14.0
 */
class VuepressConfig extends CommonGithubConfig {
  constructor(
    ...
    this.placeholder.knowledgeSpaceReadonlyModeTip = "Vuepress 平台暂不支持修改发布目录，如需修改，请删除之后重新发布"
