/* eslint-disable @typescript-eslint/strict-boolean-expressions,@typescript-eslint/explicit-function-return-type,@typescript-eslint/no-unused-vars,@typescript-eslint/restrict-plus-operands */
...
export class CustomMetaWeblogApi {
  ...
  private doFault(ret: any) {
    ...
    if (faultObj) {
      ...
      throw new Error(
        "发生异常，错误码=>" + faultCode + "，错误信息=>" + faultString
      )
    }
