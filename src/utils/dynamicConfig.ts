 ...
 * 获取子平台列表
 */
export function getSubtypeList(ptype: PlantformType): SubPlantformType[] {
  const subtypeList: SubPlantformType[] = []
 ...
 */
export function getDefaultPlatfoemName(
  ptype: PlantformType,
  subtype: SubPlantformType,
...
export function getDynSwitchKey(plantformKey: string): string {
 ...
 * @param plantformKey
 */
export function getDynSwitchActive(plantformKey: string): string {
 ...
 * @param plantformKey
 */
export function getDynSwitchInactive(plantformKey: string): string {
