export default {
    ...
    "main.publish.github.error.tip": "由于Github的rest的API问题，导致更新暂时无法处理，如需更新请先点取消删除再新增即可，可以查看这里等待修复进度：https://github.com/terwer/src-sy-post-publisher/issues/21。",
    "main.publish.github.editmode": "编辑模式",
    "main.publish.github.editmode.simple": "简洁模式",
    "main.publish.github.editmode.complex": "详细模式",
    "main.publish.github": "发布Github",
    "main.publish.github.tip": "自动将文章的markdown文本发布到Vuepress对应的Github仓库（需要先进行相关配置）",
    "main.publish.github.no.tip": "您未开启Github发布，请在点击发布之后自行复制右侧文本",
    "main.publish.github.choose.path": "请选择目录",
    "main.publish.github.choose.path.use.default": "默认目录",
    "main.publish.github.choose.path.use.default.tip": "使用默认目录，则默认所有文章都发布在配置好的默认目录下，无需每次发布的时候来选择目录",
    ...
    "blog.top-data-tip": "温馨提示：1. 请保证思源笔记启动并且打开伺服，默认伺服地址：http://127.0.0.1:6806。 2. 0.1.0+ 以后，您可以在本页面底部点击【修改思源API地址】来修改默认配置，注意：此处修改会覆盖启动设置的值。 3. 为了获得更好的使用体验，建议使用【新窗口打开】首页。",
