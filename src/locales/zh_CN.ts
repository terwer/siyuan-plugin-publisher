export default {
    ...
    "main.publish.vuepress.github": "发布到Github",
    "main.publish.vuepress.github.tip": "勾选会自动将文章的markdown文本发布到Vuepress对应的Github仓库（需要先进行相关配置，未配置或者配置错误将忽略），不勾选需要自行复制右侧文本然后手动push提交",
