export default {
    ...
    "main.publish.github.error.tip": "Due to the API of GitHub's REST, the update cannot be treated for the time being. If you need to update, please click Delete and then add it. You can check here for the restoration progress: https: //github.com/terwer/src-sy-post -Publisher/ISSUES/21.",
    "main.publish.github.editmode": "Edit mode",
    "main.publish.github.editmode.simple": "Simple",
    "main.publish.github.editmode.complex": "Complex",
    ...
    "dynamic.platform.subtype": "Plantform subtype",
