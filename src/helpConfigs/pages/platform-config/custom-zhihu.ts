...
export const zhihuHelpConfig: PageHelpConfig = {
  ...
  summary: "通过 Cookie 授权发布到知乎专栏。图片走平台内置链路；知乎专栏归属当前不可编辑。",
  fields: {
    ...
    pageType: { tip: "知乎使用 HTML 发布。" },
    picbedService: { tip: "知乎使用平台内置图片链路；配置默认使用 Bundled，PicGo 不适用。" },
  },
  faq: [
    { q: "为什么不能修改所属专栏？", a: "知乎平台限制导致已发布文档暂不支持直接编辑专栏。需要移动时，取消/删除原文后重新选择专栏发布。" },
    { q: "Cookie 验证失败？", a: "确认浏览器已登录知乎、账号可访问专栏后台，并重新读取 Cookie。" },
    { q: "图片该选什么图床？", a: "知乎使用平台内置图片链路，默认 Bundled 即可。" },
  ],
  tour: [
    {
