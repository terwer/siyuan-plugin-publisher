...
export const csdnHelpConfig: PageHelpConfig = {
  ...
  summary: "通过 Cookie 授权发布到 CSDN。V2 已验证配置、发布、更新、删除和平台内置图片链路；默认使用 Markdown 内容发布。",
  fields: {
    ...
    pageType: { tip: "CSDN V2 默认使用 Markdown 发布。" },
    picbedService: { tip: "CSDN 已验证平台内置图片链路；默认 Bundled 已修正并可用。" },
  },
  faq: [
    { q: "Cookie 验证失败？", a: "确认浏览器已登录 CSDN 创作中心，并重新读取 Cookie。" },
    { q: "图片发布该选什么？", a: "本次 V2 验证确认 CSDN 默认 Bundled 图片链路可用，不需要额外配置 PicGo。" },
  ...
  tour: [
    ...
    },
    {
      ...
      title: "图片发布",
      content: "CSDN V2 已验证默认 Bundled 图片链路，优先保持默认。",
      placement: "bottom",
    },
    {
