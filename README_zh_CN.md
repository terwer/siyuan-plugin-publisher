...
> 最近的新版本：🎉 发布工具新版本 `1.17.2` 发布
  ...
  **这可能是目前为止，性能提升最大的一个版本。😄**
  ...
  - 特别感谢 [@cesaryuan](https://github.com/cesaryuan) 的贡献 [#786](https://github.com/terwer/siyuan-plugin-publisher/issues/786) ，发布工具性能有了质的提升。`1.17.2`版本之后，首屏启动时间从 `1600s` 提升到 `900s` 。
  - `1.17.0` 主要有以下重要变更：
    - 对AI效果进行了优化支持。
