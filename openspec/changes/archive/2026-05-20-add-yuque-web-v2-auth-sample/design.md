...
- 429（**语雀网页版** Cookie 接口）：`语雀请求过于频繁，请稍后重试。`
- 429（**语雀 Open API** `common_Yuque`）：多为**未续费专业会员**或免费版每月新建文档配额用尽，并非插件限流。见 [语雀个人定价](https://www.yuque.com/about/price#personal) 与 `verification-2026-05-20-yuque-api-membership.md`。
