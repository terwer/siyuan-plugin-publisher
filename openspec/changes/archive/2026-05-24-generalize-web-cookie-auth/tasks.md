...
- [x] 6.1 更新本 change 的验证记录或 planning 进度，写明哪些平台完成自动化、哪些完成宿主手验。
- [x] 6.2 审计 diff，确认没有修改 `useProxy` 传输分支、没有新增平台专属重复授权 UI、没有改变历史配置结构。
- [x] 6.3 归档前复核 OpenSpec specs 与实现一致，未完成真实远端验证项不得标记为已完成。
