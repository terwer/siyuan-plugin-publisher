...
__export(src_exports, {
  FormdataFetch: () => formdataFetch_default
});
module.exports = __toCommonJS(src_exports);

// src/lib/formdataFetch.ts
...
var w = (r2, i2, p) => {
  const s = i2 ?? "zhi", $ = (t2) => {
    const e2 = t2.getFullYear(), o = String(t2.getMonth() + 1).padStart(2, "0"), n = String(t2.getDate()).padStart(2, "0"), S = String(t2.getHours()).padStart(2, "0"), d = String(t2.getMinutes()).padStart(2, "0"), u = String(t2.getSeconds()).padStart(2, "0");
    return `${e2}-${o}-${n} ${S}:${d}:${u}`;
  }, c = (t2, e2) => {
    const o = $(/* @__PURE__ */ new Date()), n = typeof e2 == "boolean" ? String(e2) : e2;
    n ? console.log(`[${s}] [${o}] [DEBUG] [${r2}] ${t2}`, n) : console.log(`[${s}] [${o}] [DEBUG] [${r2}] ${t2}`);
  }, l = (t2, e2) => {
    const o = $(/* @__PURE__ */ new Date()), n = typeof e2 == "boolean" ? String(e2) : e2;
    n ? console.info(`[${s}] [${o}] [INFO] [${r2}] ${t2}`, n) : console.info(`[${s}] [${o}] [INFO] [${r2}] ${t2}`);
  }, f2 = (t2, e2) => {
    const o = $(/* @__PURE__ */ new Date()), n = typeof e2 == "boolean" ? String(e2) : e2;
    n ? console.warn(`[${s}] [${o}] [WARN] [${r2}] ${t2}`, n) : console.warn(`[${s}] [${o}] [WARN] [${r2}] ${t2}`);
  }, g = (t2, e2) => {
    const o = $(/* @__PURE__ */ new Date());
    e2 ? console.error(`[${s}] [${o}] [ERROR] [${r2}] ${t2.toString()}`, e2) : console.error(`[${s}] [${o}] [ERROR] [${r2}] ${t2.toString()}`);
  };
  return {
    debug: (t2, e2) => {
      p && (e2 ? c(t2, e2) : c(t2));
...
var FormdataFetch = class {
  logger;
  constructor(isDev) {
    this.logger = w("form-data-fetch", "zhi-formdata-fetch", isDev);
  }
  /**
   * 执行网络请求并返回数据
   *
   ...
   */
  async doFetch(url, headers, formData) {
    const blob = formDataToBlob(formData ?? new FormData());
    const stream = import_node_stream.Readable.from(blob.stream());
    const h2 = {
      ...headers,
      "Content-Length": blob.size,
      "Content-Type": blob.type
    };
    this.logger.debug("headers =>", h2);
...
var formdataFetch_default = FormdataFetch;
